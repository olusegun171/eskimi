  <!-- Sidebar starts -->
    ...
    <div style="min-height: 716px" class="w-64 absolute sm:relative bg-gray-800 shadow flex-col justify-between hidden sm:flex">
        <div class="px-8">
            <div class="h-16 w-full flex items-center">
                <img src="https://global-uploads.webflow.com/60859154db955843c7fc06e7/6086e5b19dcb8d16f5451709_Eskimi.svg" loading="lazy" alt="Eskimi White Logo" class="logo">
            </div>
            <ul class="mt-12">
                <li class="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                    <a href="{{ route('dashboard.index')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                    <a href="{{ route('dashboard.campaigns')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                    <a href="{{ route('dashboard.creatives')}}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <span class="text-sm ml-2">Creatives</span>
                    </a>
                </li>
